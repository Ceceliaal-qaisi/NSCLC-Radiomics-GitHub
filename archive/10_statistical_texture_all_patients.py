...
# This version DOES NOT require GTV1_MASK.nrrd.

#

# It searches directly for DICOM SEG and extracts:
...
# ------------------------------------------------------------
# Find frames belonging to GTV-1
# ------------------------------------------------------------
...
# ------------------------------------------------------------
# Create mask in SEG frame space
# ------------------------------------------------------------
